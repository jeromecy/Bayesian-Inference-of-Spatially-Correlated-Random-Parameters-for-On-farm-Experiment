...
and for multivariate Student-$t$ distribution
	...
	\textcolor{red}{Then the posterior distribution can be calculated by combining the likelihood and prior distribution using equation \eqref{eq:posterior}. See \textcite{Besag1999Bayesian,Tsionas2002Bayesian}. }
